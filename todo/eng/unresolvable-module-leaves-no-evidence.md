...
**2026-08-17, review of #102** — Three benign shapes do reach the warning, reproduced against the merged logic: a project-local PEP 420 namespace package, an optional dependency behind `try/except ImportError`, and a `TYPE_CHECKING`-only import of a package absent at runtime. None occur in this repo, so nothing here reopens; picked up as [fingerprint-warning-false-positives](./fingerprint-warning-false-positives.md).
