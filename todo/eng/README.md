...
Work tracked upstream in the `mini` library carries a [z0u/mi-ni](https://github.com/z0u/mi-ni/issues) link. Always qualify those numbers: a bare `#38` resolves against *this* repo, where it lands on an unrelated pull request.
