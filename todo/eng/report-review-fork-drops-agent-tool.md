...
**2026-08-20, housekeeping** — PR #111 takes the second option (drops `context: fork` from the report-review skill so the router keeps `Agent`). Open, not merged; leave this item open until it lands.
