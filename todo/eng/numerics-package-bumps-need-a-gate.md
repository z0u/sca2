...
**2026-08-20, housekeeping** — PR #109 takes the middle option (detection-only warning + `mini status` line, jax/jaxlib/numpy recorded per attempt). Open, not merged; leave this item open until it lands.
