...
Good alt text is what you'd say about the image if you were reading aloud to a blind friend: a brief, well-judged remark that lets them follow along. Consider:
...
Captions serve a different purpose: they assume the content of the image is already accessible to the reader. The caption should make a _statement_ about it.
